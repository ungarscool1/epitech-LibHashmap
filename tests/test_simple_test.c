...
{
    my_hashmap *map = malloc(sizeof(my_hashmap));
...
Test(hashmap, map_is_NULL, .timeout = 30)
{
    ...
    cr_assert_eq(my_hashmap_contains(map, "test"), -1);
    cr_assert_eq(my_hashmap_put(&map, "test", "data"), 0);
    cr_assert_eq(my_hashmap_set(&map, "test", "data"), 0);
    cr_assert_eq(my_hashmap_contains_from_data(map, "test"), -1);
    cr_assert_null(my_hashmap_get_from_data(map, "This is a test"));
    cr_assert_null(my_hashmap_get(map, "test"));
